...
CC  = avr-gcc
OPTIM   = -Os -fdata-sections -ffunction-sections $(call check,-fno-split-wide-types)
CFLAGS  = -Wall -I. $(DEBUG_FLAGS) $(INCLUDES) $(OPTIM) -DF_CPU=$(F_CPU)
LDFLAGS = -Wl,--relax,--gc-sections,-Map,main.map
MODULES = $(OBJECTS)
